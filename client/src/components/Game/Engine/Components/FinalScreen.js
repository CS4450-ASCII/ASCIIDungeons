...
export class FinalScreen extends GameObject {
  ...
  constructor() {
    ...
    this.congratsMessage = new Message("Congratulations!!!");
    this.timeMessage = new Message("You found the McGuffin in: ",0,1);
    this.totalTime = 0;
    this.startTime = 1000;
  ...
  step(deltatime) {
    ...
    switch(this.animationState) {
      case 0:
        ...
        break;
      case 1:
        if(this.congratsMessage.text === this.congratsMessage.fullText) this.animationState = 2;
        break;
      case 2:
        ...
        break;
      case 3:
        if(this.timeMessage.text === this.timeMessage.fullText) this.animationState = 4;
        break;
      /*case 4:
  ...
  getFormattedTime() {
    ...
    let timeString = hours.toString().padStart(2,"0")+":"+minutes.toString().padStart(2,"0")+":"+Math.trunc(seconds).toString().padStart(2,"0")+"."+((seconds-Math.trunc(seconds)).toFixed(3)*1000).toString().padStart(3,"0");
