...
export class WelcomeScreen extends GameObject {
  ...
  constructor() {
    ...
    this.dungeonMessage = new Message("Welcome to "+this.GE.mountedGame.title+"!");
    this.mcGuffinMessage = new Message("Your mission is to find "+this.genMcGuffin()+".",0,1);
  ...
  step(deltatime) {
    ...
    switch(this.animationState) {
      case 0:
        ...
        break;
      case 1:
        if(this.dungeonMessage.text === this.dungeonMessage.fullText) this.animationState = 2;
        break;
      case 2:
        ...
        break;
      case 3:
        if(this.mcGuffinMessage.text === this.mcGuffinMessage.fullText) this.animationState = 4;
        break;
      case 4:
  ...
  genMcGuffin() {
    return this.mcGuffinOwners[Math.floor(Math.random()*this.mcGuffinOwners.length)]+"'s "+this.mcGuffinAdjs[Math.floor(Math.random()*this.mcGuffinAdjs.length)]+" "+this.mcGuffinObjs[Math.floor(Math.random()*this.mcGuffinObjs.length)];
  }
}